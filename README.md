...
- 처음 혼자 개인 프로젝트를 만들어보았다. 팀으로 만들 때와 다르게 디자인과 각종 업무들을 혼자 해야했기 때문에 많이 고민하고 살짝 버거웠다. 여러 기능들을 더 추가할 예정이고(ex.셔플재생, 반복재생 등등) 디자인도 좀 손봐야 될거같다...ㅎㅎ 좋은 경험이었고 스킬 향상에 도움이 많이 되었다. 
